...
/**
 * Alert component with success/error/warning/info variants
 */
export const Alert: React.FC<AlertProps> = ({
  ...
  const variantStyles: Record<AlertVariant, { bg: string; icon: string; title: string; text: string }> = {
    success: {
  ...
  return (
    <div
      className={`rounded-md border p-4 ${styles.bg} ${className}`}
      role="alert"
    >
      <div className="flex">
