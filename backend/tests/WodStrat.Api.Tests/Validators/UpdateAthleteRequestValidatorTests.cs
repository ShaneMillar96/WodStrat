...
/// <summary>
/// Unit tests for UpdateAthleteRequestValidator.
/// </summary>
public class UpdateAthleteRequestValidatorTests
{
    private readonly UpdateAthleteRequestValidator _validator;

    public UpdateAthleteRequestValidatorTests()
    {
        _validator = new UpdateAthleteRequestValidator();
    }
    ...
    public void Validate_ValidAge_NoValidationError()
    {
        // Arrange
        var request = CreateValidRequest();
        request.DateOfBirth = DateOnly.FromDateTime(DateTime.UtcNow.AddYears(-30));
    ...
    private static UpdateAthleteRequest CreateValidRequest()
    {
        return new UpdateAthleteRequest
        {
